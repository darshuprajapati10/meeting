...
onMounted(() => {
    ...
    if (urlParams.get('registered') === 'true' || props.registered) {
    ...
    <div class="min-h-screen bg-gradient-radial bg-hero-pattern flex">
        ...
        <div class="flex-1 flex items-center justify-center p-8">
            <div class="w-full max-w-md">
                ...
                <div v-if="showSuccessMessage" class="mb-6 p-4 bg-green-50 border border-green-200 rounded-xl animate-fade-in-up delay-200">
                    <div class="flex items-center gap-2">
                        <svg class="w-5 h-5 text-green-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                        <p class="text-sm text-green-700 font-medium">Registration successful! Please sign in to continue.</p>
                    </div>
                </div>
